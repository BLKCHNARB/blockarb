            ...
            <div class=" h-screen flex relative" x-data="{ open: false }">
                <div class=" hidden lg:w-72 bg-white lg:flex flex-col border-r border-gray-300">
                    <div class=" p-5 border-b border-gray-300">
                        ...
                        <a class=" flex bg-seconday p-2 pt-4 rounded-sb items-center mt-2"
                    ...
                    <div class=" p-5 flex flex-col justify-between flex-1 overflow-auto">
                        ...
                        <div class="flex space-x-2 m-auto">
                            <div class=" rounded-md border border-gray-400 p-1 text-gray-600">
                                <a href="https://www.linkedin.com/company/blockarb" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-linkedin"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg>
                                </a>
                            </div>

                            <div class=" rounded-md border border-gray-400 p-1 text-gray-600">
                                <a href="https://medium.com/@blockarb" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        aria-hidden="true" role="img" width="20" height="20"
                                        preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                                        <path fill="currentColor"
                            ...
                            <div class=" rounded-md border border-gray-400 p-1 text-gray-600">
                                <a href="https://m.facebook.com/BlockArb/" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                        ...
                        <div class=" bg-primary-800 rounded-lg p-3">
                            <div class="flex flex-col space-y-4 text-gray-100">
                                ...
                                <a class="{{ request()->is('user/settings') ? ' bg-primary-200 text-primary-700 ' : ' ' }} flex p-2 pl-3 rounded-sb items-center"
                                    href="{{ route('settings') }}">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none"
                                        viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                        <path stroke-linecap="round" stroke-linejoin="round"
                ...
                <div x-data="{ show: false }"
                    ...
                    <div class="flex border-y-2 border-gray-300 p-5 px-8 items-center">
                        <div class="  rounded-full bg-green-200 p-5 w-3 h-3 flex items-center justify-center">
                    ...
                    <div class=" overflow-hidden">
                        <div class=" duration-500"
                            :class="{ 'translate-y0 h-44': show == true, '-translate-yfull h-0': show == false }">
                            <div class=" py-5 px-8">
                                <div class=" mt-">
                                    <div class=" flex text-blue-500 mt-1">
                                        <a href="{{ route('deposit') }}" class=" mr-4 text-sm">Deposit Funds</a>
                                    ...
                                    <div class=" flex text-blue-500 mt-1">
                                        <a href="{{ route('withdrawal') }}" class=" mr-4 text-sm">Withdraw Funds</a>
                                        <svg xmlns="http://www.w3.org/2000/svg"
                                            xmlns:xlink="http://www.w3.org/1999/xlink" aria-hidden="true"
                                            role="img" width="20" height="20"
                            ...
                            <div class=" py-5 px-8 ">
                                <a href="{{ route('settings') }}" class=" flex text-gray-500 mb-3 items-center">
                                ...
                                <a href="{{ route('settings') }}" class=" flex text-gray-500 items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        aria-hidden="true" role="img" width="20" height="20"
                                        preserveAspectRatio="xMidYMid meet" viewBox="0 0 24 24">
                                        <path fill="currentColor"
                    ...
                    <div class=" p-5 flex flex-col justify-between flex-1 overflow-auto border--2 border-gray-300">
                        ...
                        <div class="flex space-x-2 my-4 lg:my-0 m-auto">
                            <div class=" rounded-md border border-gray-400 p-1 text-gray-600">
                                <a href="#">
                                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                                        xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div class=" w-full lg:w-auto py-3 px-4 md:px-10 bg-white fixed z-10 lg:left-72 right-0 shadow-sm">
                        <div class="flex justify-between lg:hidden">
                            ...
                            <div x-data="{ display: false }" class="rounded-full relative">
                                ...
                                <div class="absolute top-10 duration-300 right-0 bg-white shadow-lg rounded-sm whitespace-nowrap"
                                    :class="{
                                        'translate-y-0 opacity-100 visible': display ==
                                            true,
                                        'translate-y-3 opacity-0 invisible': display == false
                                    }">
                                    <div class=" py-5 px-8">
                                        <div class=" mt-">
                                            <div class=" flex text-blue-500 mt-1">
                                    ...
                                    <div class=" py-5 px-8 ">
                                        ...
                                        <form method="POST" action="{{ route('logout') }}">
                                            @csrf
                                            <a class=" flex items-center text-gray-500" href="{{ route('logout') }}"
                                                onclick="event.preventDefault();
                                                this.closest('form').submit();">
