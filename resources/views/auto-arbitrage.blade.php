<x-guest-layout>
        ...
        <div class=" lg:max-w-screen-lg px-4 sm:px-8 lg:px-10 py-24 mx-auto relative">
            <div class="grid grid-cols-1 md:grid-cols-12 gap-16 divide- divide-gray-500">
                <div class=" md:col-span-10">
                    ...
                    <div class=" mt-5">
                        <h1 class=" text-5xl font-bold uppercas text-secondary">Auto Arbitrage</h1>
                        <div class="lg:flex items-baseline gap-6">
                            ...
                            <div class=" lg:w-2/3">
                                <h4 class=" text-lg text-gray-200 pt-[38px] leading-relaxed font-semibol">
                                    Auto.Arbitrage is a fund focused on generating yield within the cryptocurrency space
                                    through a wide array of arbitrage and relative value strategies. The fund seeks
                                    absolute returns without taking a directional view on the cryptocurrency market.
                                </h4>
    ...
    <section class=" py-20 mx-auto xl:max-w-screen-x">
        <div class="lg:grid grid-cols-12 gap- ">
            ...
            <div class="col-span-6 hidden lg:block">
                <img class=" h-full object-cover" src="{{ asset('images/img18.jpg') }}" alt="">
            </div>
            ...
            <div class="col-span-6 flex">
                <div class=" px-4 sm:px-8 lg:px-20 text-gray-10 m-auto">
                    ...
                    <p class=" text-s leading-7">
                        Auto.Arbitrage delivers consistent positive returns within a strictly defined risk framework by
                        exploiting a highly fragmented market place with extreme volatility, high momentum, temporary
                        dislocation and lower liquidity. This strategy is not designed to give a directional exposure to
                        crypto assets but instead will deliver uncorrelated positive returns with a high Sharpe ratio.
                    </p>
                    <br>
                    <p class="leading-7">
                        The fund is suitable for those investing in USD or in kind (BTC, ETH & USDC). In-kind investors
                        combine the benefits of a long position on liquid cryptocurrencies with high yield returns from
                        arbitrage trading.
                    </p>
    ...
    <section class=" py-20 lg:py-40 mx-auto xl:max-w-screen-xl lg:max-w-screen-lg px-4 sm:px-8 lg:px-10">
        <div class="lg:grid grid-cols-12 gap- ">
            ...
            <div class="col-span-6 flex">
                <div class=" px-4 sm:px-8 lg:px-20 text-gray-10 m-auto">
                    <div class="flex mb-10 gap-5">
                        ...
                        <h3 class=" font-bold text-5xl text-primary">Overview</h3>

                    </div>

                    <p class=" text-s leading-7">
                        Arbitrage is the process of simultaneous buying and selling of an asset from different
                        platforms, exchanges or locations to cash in on the price difference. The price differential of
                        the same asset in different markets is known as arbitrage and profiting from the differential is
                        known as arbitrage trading.
                    </p>
                    <br>
                    <p class="leading-7">
                        Arbitrage opportunities exist due to inherent inefficiencies in the financial markets. Supply
                        and demand are the primary driving factors behind the markets, and a change in either of them
                        can affect an asset’s price.
                    </p>
                    <br>
                    <p class="leading-7">
                        ...
                        algorithms are quick to spot and capture arbitrage opportunities, making it hard for human
                        traders to keep track.
                    </p>
            ...
            <div class="col-span-6 hidden lg:block">
                <img class=" h-full object-cover" src="{{ asset('images/img19.jpg') }}" alt="">
            </div>
    ...
    <section class=" py-20 lg:py-40 mx-auto xl:max-w-screen-xl lg:max-w-screen-lg px-4 sm:px-8 lg:px-10">
        <div class="lg:grid grid-cols-12 gap- ">
            ...
            <div class="col-span-6 hidden lg:block">
                <img class=" h-full object-cover" src="{{ asset('images/img20.jpg') }}" alt="">
            </div>
            ...
            <div class="col-span-6 flex">
                <div class=" px-4 sm:px-8 lg:px-20 text-gray-10 m-auto">
                    <div class="flex mb-10 gap-5">
                        ...
                        <div class="w-1/3 h-[0.5px] bg-gray-800 my-5"></div>
                        <h3 class=" font-bold text-3xl text-primary">Arbitrage in the cryptocurrency market.</h3>

                    </div>

                    <p class=" text-s leading-7">
                        Cryptocurrency markets exhibit periods of large, recurrent arbitrage opportunities across
                        exchanges. A number of features make the cryptocurrency market a unique place for trading
                        arbitrage and price formation. There are many nonintegrated exchanges that are independently
                        owned and exist in parallel across countries.
                        On an individual basis the majority of these exchanges function like traditional equity markets
                        where traders submit buy and sell orders, and the exchange clears trades based on a centralised
                        order book.

                    </p>
                    <br>
                    <p class="leading-7">
                        However, in contrast to traditional, regulated equity markets, the cryptocurrency market lacks
                        any provisions to ensure that investors receive the best price when executing trades. The
                        absence of such mechanisms increases the role of arbitrageurs who can trade across different
                        markets.
                    </p>
                    <br>
    ...
    {{-- <div class="grid grid-cols-1 lg:grid-cols-12 xl:max-w-screen-xl lg:max-w-screen-lg px-4 py-24 mx-auto gap-24">
        <div class="md:col-span-6 xl:col-span-5">
            <div>
                <h2 class=" font-bold text-3xl">Competitive Advantage</h2>
        ...
        <div class=" md:col-span-6 xl:col-span-7">
            <div class=" flex">
                ...
                <div class=" ml-5">
                    <h4 class=" text-2xl font-bold">Quantitative Research</h4>
                    <h6 class=" mt-5 text-sm leading-6">Our quantitative research team, holding advanced degrees in the
                        fields of
                        science and engineering, analyzes vast amounts of historical data with the objective of gaining
                        insights in financial markets and uncover profitable investment opportunities, with the support
                        of sophisticated statistical tools.</h6>
                </div>
            </div>
            ...
            <div class=" flex mt-10">
                ...
                <div class=" ml-5">
                    <h4 class=" text-2xl font-bold">Technology</h4>
                    <h6 class=" mt-5 text-sm leading-6">Technology is a critical component for our business. First of
                        all it supports the work of our quantitative researcher who use advanced statistical tools and
                        algorithms. Second, it enables the execution of our automated investment strategies. We make
                        substantial investments to constantly improve our technology with the objective of having a
                        robust infrastructure capable of handling and managing large investment portfolios.</h6>
                </div>
            </div>
            ...
            <div class=" flex mt-10">
                ...
                <div class=" ml-5">
                    <h4 class=" text-2xl font-bold">Risk Management</h4>
                    <h6 class=" mt-5 text-sm leading-6">Preserving capital for our clients is a primary principle in
                        our organization. In the pursuit of our objective, we use a sophisticated risk management
                        framework which monitors various types of risks related to our investments. We have both
                        automated and manual procedures in place to manage risk and promptly intervene when needed.</h6>
                </div>
            </div>
            ...
            <div class=" flex mt-10">
                ...
                <div class=" ml-5">
                    <h4 class=" text-2xl font-bold">Innovation</h4>
                    <h6 class=" mt-5 text-sm leading-6">Financial markets are always changing and profit opportunities
                        may disappear at any time. For this reason, our investment team constantly searches for new
                        sources of alpha using a variety of quantitative tools and datasets. Through continous
                        innovation we aim to provide a diversified portfolio of investment products with differences
                        sources of alpha.</h6>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 xl:max-w-screen-xl lg:max-w-screen-lg px-4 py-24 mx-auto gap-24">
        <div class="md:col-span-6 xl:col-span-5">
            <div>
                <h2 class=" font-bold text-4xl">Our Clients</h2>
                <h5 class=" text-base mt-10 leading-relaxed">Our mission is to be a partner of both individual and
                    institutional
                    investors who need help in order to manage their capital. We understand that each of our clients has
                    a unique set of requirements that needs to be satisfied. For this reason, we work closely with our
                    clients to understand their specific investment goals and see if one of our investment products can
                    provide a solution.</h5>
            </div>
        </div>

        <div class=" md:col-span-6 xl:col-span-7">
            <div class=" bg-secondary px-5 py-10 rounded-lg relative">
                <div class="flex items-center">
                    ...
                    <div class=" ml-5">
                        ...
                        <p class="mt-5 text-sm leading-6">
                            ...
                            management process. At Arbitrage Finance we work closely with investors to understand their
                ...
                <div class="flex items-center">
                    ...
                    <div class=" ml-5">
                        ...
                        <p class="mt-5 text-sm leading-6">
                            ...
                            allocation to uncorrelated strategies in the alternative investment space. In particular,
                            our team has a discussion to understand exposures to traditional and alternative investments
            ...
            <div class=" bg-secondary px-5 py-10 rounded-lg relative">
                <div class="flex items-center">
                    ...
                    <div class=" ml-5">
                        ...
                        <p class="mt-5 text-sm leading-6">
                            We can work with public and private pension funds, corporations, asset and private wealth
                            managers, not-for-profit organizations. Our objective is to understand their unique needs
                            and objectives in terms of target risk and returns, and see if one of our investment product
