        ...
        <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
            <div
                    ...
                    <tbody class="bg-white">
                        ...
                        @forelse ($tokens as $token)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <div class="text-sm leading-5 text-gray-500">{{ $token->name }}</div>
                                </td>

                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <div class="text-sm leading-5 text-gray-500">{{ $token->address }}</div>
                                </td>

                                <td
                                    class="px-6 py-4 text-sm leading-5 text-gray-500 whitespace-no-wrap border-b border-gray-200">
                                    <button type="button" wire:click="editmodal({{$token->id}})">
                                ...
                                <td
                                    class="px-6 py-4 text-sm leading-5 text-gray-500 whitespace-no-wrap border-b border-gray-200">
                                    <button type="button" wire:click="deletemodal({{$token->id}})">
                        ...
                        @empty
                            <h5>You have created no tokens yet</h5>
                        @endforelse
                ...
                <x-confirmation-modal wire:model='editingmodal'>
                    ...
                    <x-slot name="content">
                        <form action="" wire:submit.prevent = updateToken>
                            <div class="md:grid grid-cols-2 gap-12">
                                <div class="mt-5 ">
                                    <label class=" block" for="name">Name</label>
                                    <input placeholder="Enter Token Name" value="{{$name}}" wire:model="name"
                                ...
                                <div class="mt-5 ">
                                    ...
                                    <input wire:model="address" placeholder="Enter Token Address" value="{{$address}}"
                                        class=" pl-0 text-sm text-gray-400 placeholder-gray-300 mt-2 block bg-transparent w-full border-t-0 focus:ring-0 focus:outline-none focus:border-non border-l-0 border-r-0 border-b border-gray-300"
                ...
                <x-confirmation-modal wire:model='creatingmodal'>
                    ...
                    <x-slot name="content">
                        <form action="" wire:submit.prevent = createToken>
                            <div class="md:grid grid-cols-2 gap-12">
                                <div class="mt-5 ">
                                    <label class=" block" for="cname">Name</label>
                                    <input placeholder="Enter Token Name" value="{{$cname}}" wire:model="cname"
                                        class=" pl-0 text-sm text-gray-400 placeholder-gray-300 mt-2 block bg-transparent w-full border-t-0 focus:ring-0 focus:outline-none focus:border-non border-l-0 border-r-0 border-b border-gray-300"
                                        type="text" cname="cname" id="cname" wire:model.debounce.lazy="cname" />
                                </div>
                                <div class="mt-5 ">
                                    <label class=" block" for="caddress">Address</label>
                                    <input wire:model="caddress" placeholder="Enter Token Address" value="{{$caddress}}"
                                        class=" pl-0 text-sm text-gray-400 placeholder-gray-300 mt-2 block bg-transparent w-full border-t-0 focus:ring-0 focus:outline-none focus:border-non border-l-0 border-r-0 border-b border-gray-300"
                                        type="text" name="caddress" id="caddress">
                                </div>
