        ...
        <div class="py-2 -my-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
            <div class="inline-bloc min-w-full overflow-auto align-middle border-b border-gray-200 shadow sm:rounded-lg">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <div class="text-sm leading-5 text-gray-500">
                                        {{ $claim->user->first_name . ' ' . $claim->user->last_name }}</div>
                                </td>

                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <div class="text-sm leading-5 text-gray-500">{{ $claim->user->email }}</div>
                                </td>

                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <div class="text-sm leading-5 text-gray-500">{{ $claim->token->name }}</div>
                                </td>

                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <div class="text-sm leading-5 text-gray-500">{{ $claim->amount }}</div>
                                </td>

                                <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                    <div class="text-sm leading-5 text-gray-500">{{ $claim->processed }}</div>
                                </td>

                                <td class="px-6 py-4 whitespace-no-wrap text-sm leading-5">
                                    <div class="flex">
                                        <button wire:click='processmodal({{ $claim->id }})'
                                        ...
                                        <button wire:click='deletemodal({{ $claim->id }})' type="button"
                ...
                <x-confirmation-modal wire:model='processingmodal'>
                    ...
                    <x-slot name="content">
                        {{ __('Are you sure you want to process this claim?') }}
                    </x-slot>
